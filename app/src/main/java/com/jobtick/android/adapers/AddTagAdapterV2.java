...
public class AddTagAdapterV2 extends RecyclerView.Adapter<AddTagAdapterV2.ViewHolder> {
    ...
    public AddTagAdapterV2(List<String> items, Boolean isAdded, OnItemClickListener mItemClickListener) {
