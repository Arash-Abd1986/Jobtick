...
public class AttachmentAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AttachmentAdapter2(List<AttachmentModel> items, Boolean delete_action) {
        this.items = items;
        this.delete_action = delete_action;
    }

    public AttachmentAdapter2(List<AttachmentModel> items, Boolean delete_action, Context context) {
        this.items = items;
        this.delete_action = delete_action;
        ...
        switch (viewType) {
            case VIEW_TYPE_IMAGE:
                return new IMAGEViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.item_show_attachment_2, parent, false));
            case VIEW_TYPE_ADD:
            default:
