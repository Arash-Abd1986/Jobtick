...
public class QuestionAttachmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public QuestionAttachmentAdapter(List<AttachmentModel> items, Boolean delete_action) {
        this.items = items;
