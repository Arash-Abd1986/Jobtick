...
public class QuestionAttachmentAdapterV2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public QuestionAttachmentAdapterV2(List<AttachmentModel> items, Boolean delete_action) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
                return new IMAGEViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.item_question_attachment, parent, false));
    }
