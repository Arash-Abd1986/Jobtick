...
class RippleView(context: Context?, private val attrs: AttributeSet?) : RelativeLayout(context, attrs) {
    ...
    init {
        ...
        rippleRadius = styledAttributes.getDimension(R.styleable.RippleView_rv_radius, resources.getDimension(R.dimen.buttonCorners))
        rippleStrokeWidth = styledAttributes.getDimension(R.styleable.RippleView_rv_strokeWidth, resources.getDimension(R.dimen._3sp))
