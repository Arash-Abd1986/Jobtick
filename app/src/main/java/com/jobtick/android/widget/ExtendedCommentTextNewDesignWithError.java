...
public class ExtendedCommentTextNewDesignWithError extends RelativeLayout implements View.OnClickListener, View.OnFocusChangeListener, TextWatcher {
    ...
    public ExtendedCommentTextNewDesignWithError(Context context) {
        this(context, null);
    }

    public ExtendedCommentTextNewDesignWithError(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExtendedCommentTextNewDesignWithError(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_extended_comment_text_new_design_with_error, this);
