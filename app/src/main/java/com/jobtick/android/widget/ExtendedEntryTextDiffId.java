...
public class ExtendedEntryTextDiffId extends RelativeLayout implements View.OnClickListener, View.OnFocusChangeListener, TextView.OnEditorActionListener, TextWatcher {
    ...
    public ExtendedEntryTextDiffId(Context context) {
        this(context, null);
    }

    public ExtendedEntryTextDiffId(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExtendedEntryTextDiffId(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (eInputType == EInputType.AUTOCOMPLETE) {
            ...
            secondEditText = (EditText) findViewById(R.id.content_diff_id);
        } else
            editText = (EditText) findViewById(R.id.content_diff_id);
