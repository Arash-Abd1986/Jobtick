...
public class CancellationPosterActivity extends ActivityBase implements RadioGroup.OnCheckedChangeListener{

    private String TAG = CancellationPosterActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancellation_poster);
    ...
    private void getNoticeList() {
                    ...
                    try {
                        ...
                        if (jsonObject.has("success") && !jsonObject.isNull("success")) {
                            if (jsonObject.getBoolean("success")) {
                                ...
                                showToast("Something went Wrong", CancellationPosterActivity.this);
                            }
                        }
                    ...
                    if (networkResponse != null && networkResponse.data != null) {
                        ...
                        try {
                            ...
                            if (jsonObject_error.has("message")) {
                                Toast.makeText(CancellationPosterActivity.this, jsonObject_error.getString("message"), Toast.LENGTH_SHORT).show();
                            }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CancellationPosterActivity.this);
    ...
    private void setReasons(CancellationReasonModel cancellationReasonModel) {
        for (int i = 0; cancellationReasonModel.getPoster().size() > i; i++) {
            switch (i) {
                case 0:
                    rbReason1.setText(cancellationReasonModel.getPoster().get(i));
                    break;
                case 1:
                    rbReason2.setText(cancellationReasonModel.getPoster().get(i));
                    break;
                case 2:
                    rbReason3.setText(cancellationReasonModel.getPoster().get(i));
                    break;
                case 3:
                    rbReason4.setText(cancellationReasonModel.getPoster().get(i));
                    break;
                case 4:
                    rbReason5.setText(cancellationReasonModel.getPoster().get(i));
                    break;
                    ...
                    try {
                        ...
                        if (jsonObject.has("success") && !jsonObject.isNull("success")) {
                            if (jsonObject.getBoolean("success")) {
                                ...
                                intent = new Intent(CancellationPosterActivity.this, CancellationSubmitedActivity.class);
