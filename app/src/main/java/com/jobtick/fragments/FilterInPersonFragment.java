 ...
 */
public class FilterInPersonFragment extends Fragment {
    ...
    CardView cardButton;
    private String TAG = FilterInPersonFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_filter_in_person, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            if (getArguments().getParcelable(Constant.FILTER) != null) {
                ...
                if (filterModel != null && filterModel.getSection().equalsIgnoreCase(Constant.FILTER_IN_PERSON)) {
